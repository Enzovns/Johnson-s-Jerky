...
const DEMO_PRODUCTS: Product[] = [
  { id: 'd1', name: 'Outback Beef Jerky — Original', description: 'Slow-dried premium beef with classic outback seasoning. Simple, bold, unforgettable.', price_cents: 1800, image_url: 'https://placehold.co/400x400/B85C38/F5E6D3?text=Outback+Jerky', category: 'Jerky', available: true, stripe_payment_link: null },
  { id: 'd2', name: 'Roo Biltong', description: "Kangaroo dried with traditional bush spices. Lean, rich, uniquely Australian.", price_cents: 2200, image_url: 'https://placehold.co/400x400/8B3A1F/E8D5B7?text=Roo+Biltong', category: 'Biltong', available: true, stripe_payment_link: null },
  { id: 'd3', name: 'Smoky Bushranger Jerky', description: 'Smoked beef with cracked pepper and roasted garlic. Ride hard, eat harder.', price_cents: 2500, image_url: 'https://placehold.co/400x400/3E2723/C9A961?text=Bushranger', category: 'Jerky', available: true, stripe_payment_link: null },
  { id: 'd4', name: 'Spicy Desert Strips', description: 'Chilli and paprika-crusted beef strips with slow Outback heat.', price_cents: 1900, image_url: 'https://placehold.co/400x400/C9A961/3E2723?text=Spicy+Desert', category: 'Jerky', available: true, stripe_payment_link: null },
]
